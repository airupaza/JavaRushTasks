...
public class Solution {
    ...
    public static void cleanAllApartments(List<Apartment> apartments) {
        for (Apartment object:apartments){
            if (object instanceof Apt1Room) ((Apt1Room) object).clean1Room();
            if (object instanceof Apt2Room) ((Apt2Room) object).clean2Rooms();
            if (object instanceof Apt3Room) ((Apt3Room) object).clean3Rooms();
        }
    }
